...
# board = [
# [(0,2),(0,3),(0,4),(0,4),(0,4),(0,4),(0,4),(0,3),(0,2)],
# [(0,3),(0,4),(0,6),(0,6),(0,6),(0,6),(0,6),(0,4),(0,3)],
# [(0,4),(0,6),(0,8),(0,8),(0,8),(0,8),(0,8),(0,6),(0,4)],
# [(0,4),(0,6),(0,8),(0,8),(0,8),(0,8),(0,8),(0,6),(0,4)],
# [(0,4),(0,6),(0,8),(0,8),(0,8),(0,8),(0,8),(0,6),(0,4)],
# [(0,4),(0,6),(0,8),(0,8),(0,8),(0,8),(0,8),(0,6),(0,4)],
# [(0,3),(0,4),(0,6),(0,6),(0,6),(0,6),(0,6),(0,4),(0,3)],
    ...
    for row in range(8):
        for column in range(8):
            if board[row][column] > highest_move:
                highest_move = board[row][column][0]
...
def main():
    ...
    while move_count < 64:
        ...
        if len(legal_moves) == 0:
            ...
            reset_board()
            print(move_count)
            board[starting_postion[0]][starting_postion[1]][0] = 1
            move_count = 1
            continue
